...
class Config:
    ...
    def _load_mcp_servers(self):
        ...
        if mcp_config_file.exists():
            try:
                ...
                logger.info(f"Loaded {len(self.mcp_servers)} MCP server configs from {mcp_config_file}")
            except Exception as e:
    ...
    def _create_default_mcp_config(self):
        ...
        try:
            ...
            logger.info("To enable MCP servers, install Node.js and configure mcp_servers.json")
