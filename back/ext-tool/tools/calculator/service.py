...
class CalculatorService:
    ...
    async def calculate_simple(self, expression: str, precision: int = 10) -> CalculationResult:
    ...
    def list_functions(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "constants": ["pi", "e"],
            "statistics": ["mean", "median", "mode", "std", "var", "min", "max", "sum", "count", "range", "quartiles"],
            "examples": [
                "2 + 3 * 4",
                "sqrt(16)",
                "sin(pi/2)",
